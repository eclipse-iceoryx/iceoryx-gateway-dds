...
// ======================================== Helpers ======================================== //
using TestDataReader = FastDataReader;
...
// ======================================== Fixture ======================================== //
class FastDataReaderTest : public Test
{
  public:
    void SetUp() {};
    void TearDown() {};
...
// ======================================== Tests ======================================== //
TEST_F(FastDataReaderTest, DoesNotAttemptToReadWhenDisconnected)
{
...
TEST_F(FastDataReaderTest, ReturnsErrorWhenAttemptingToReadIntoANullBuffer)
{
